...
#define RN2483ResetPin		P2  //drive this pin low to reset RN2483
#define RN2483Tx			P0_20
#define RN2483Rx			P0_18
#define RN2483TxPin			P12
#define RN2483RxPin			P8
#define GroveIOD0Pin		P0
#define GroveIOD1Pin		P1
#define I2CSDAPin			MICROBIT_PIN_P20 // Default mBit I2C
#define I2CSCLPin			MICROBIT_PIN_P19 // Default mbit I2c
