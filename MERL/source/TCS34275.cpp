...
{
	char i2creg[2];
	i2creg[0] = TCS34725_COMMAND_BIT | reg;
	i2creg[1] = value & 0xFF; 
	uBit.i2c.write(TCS34725_ADDRESS, (char*) &i2creg,2);
}
...
{
	char i2creg = TCS34725_COMMAND_BIT | reg;
	char i2cval;
	uBit.i2c.write(TCS34725_ADDRESS, (char*) &i2creg,1, true);
	uBit.i2c.read(TCS34725_ADDRESS, (char*) &i2cval, 1);
	return i2cval;
}
...
uint16_t Adafruit_TCS34725::read16(uint8_t reg)
{
	...
	uint16_t x;
	uBit.i2c.write(TCS34725_ADDRESS, (char*) &i2creg,1, true);
	uBit.i2c.read(TCS34725_ADDRESS, (char*) &i2cval, 2);
	x = (i2cval[1] << 8) |  i2cval[0];
	return x;
...
void Adafruit_TCS34725::clearInterrupt(void) {
	...
	char i2creg = TCS34725_COMMAND_BIT | 0x66;
	uBit.i2c.write(TCS34725_ADDRESS, (char*) &i2creg,1);
}
